...
Os tutoriais utilizados como base para este estudo estão disponíveis publicamente:

* **Tutorial Razor Pages com EF Core:** [https://learn.microsoft.com/pt-br/aspnet/core/data/ef-rp/intro?view=aspnetcore-8.0](https://learn.microsoft.com/pt-br/aspnet/core/data/ef-rp/intro?view=aspnetcore-8.0)
* **Tutorial MVC com EF Core:** [https://learn.microsoft.com/pt-br/aspnet/core/data/ef-mvc/intro?view=aspnetcore-8.0](https://learn.microsoft.com/pt-br/aspnet/core/data/ef-mvc/intro?view=aspnetcore-8.0)

O objetivo é destacar as diferenças práticas na estrutura do projeto, filosofia de desenvolvimento, fluxo de dados e produtividade do desenvolvedor.
