    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
                ...
                s => s.FirstMidName, s => s.LastName, s => s.EnrollmentDate))
            {
                ...
                {
                    // Registe o erro (descomente a variável ex e escreva um log.)
                    ModelState.AddModelError("", "Não foi possível salvar as alterações. " +
                        "Tente novamente e, se o problema persistir, " +
                        "consulte o administrador do sistema."); // <-- Mensagem traduzida
                }
            }
        ...
        public async Task<IActionResult> Delete(int? id, bool? saveChangesError = false)
        {
            ...
            if (saveChangesError.GetValueOrDefault())
            {
                ViewData["ErrorMessage"] =
                    "Falha ao excluir. Tente novamente e, se o problema persistir, " +
                    "consulte o administrador do sistema.";
            }
